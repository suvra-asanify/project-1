...
r.value?.$el.contains(t)||(A.value=!1)}function U(){e.eager&&c.value?.calculateVisibleItems()}function G(){m.value="",k.value&&r.value?.focus()}function K(e){k.value=!0}function q(e){if(null==e)h.value=[]
...
return t.createVNode(sv,t.mergeProps({tag:"th",class:[...S.value],colspan:p.value.length+1},e.headerProps),{default:()=>[t.createElementVNode("div",{class:"v-data-table-header__content"},[t.createVNode(vs,{chips:!0,color:e.color,class:"v-data-table__td-sort-select",clearable:!0,density:"default",items:a.value,label:n("$vuetify.dataTable.sortBy"),multiple:e.multiSort,variant:"underlined","onClick:clear":()=>r.value=[]},{append:l?()=>t.createVNode(io,{color:e.color,density:"compact",modelValue:u.value,indeterminate:s.value&&!u.value,"onUpdate:modelValue":()=>c(!u.value)},null):void 0,chip:e=>t.createVNode(Jo,{onClick:e.item.raw?.sortable?()=>o(e.item.raw):void 0,onMousedown:e=>{e.preventDefault(),e.stopPropagation()}},{default:()=>[e.item.title,t.createVNode(nn,{class:t.normalizeClass(["v-data-table__td-sort-icon",i(e.item.raw)&&"v-data-table__td-sort-icon-active"]),icon:g(e.item.raw),size:"small"},null)]})})])]})}
...
if(a&&e in a)return a[e]}Ug.version="3.12.1"
const Kg=function(){return Ug({components:Fg,directives:Wg,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},qg="3.12.1"
